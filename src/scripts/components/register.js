class RegisterPage extends HTMLElement {
    ...
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" 
        class="fixed left-0 right-0 top-0 z-50 h-[calc(100%-1rem)] max-h-full w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0 flex justify-center items-center backdrop-blur-sm">
            ...
            <div class="relative rounded-lg bg-white shadow">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <p class="my-5 text-sm text-slate-500 md:max-w-sm md:my-7" tabindex="0">
                        Input your username and password, Unlock the Full Experience and Stay Connected
                    </p>
                    <form class="space-y-6" action="#">
                        ...
                        <div class="text-sm text-gray-500 text-center" tabindex="0">
                            Sudah punya akun?
                            <a href="./login.html" class="text-greenbase hover:underline" tabindex="0" data-modal-target="authentication-modal">Login disini</a>
                        </div>
                    </form>
                </div>
            </div>
...
customElements.define('register',RegisterPage);
